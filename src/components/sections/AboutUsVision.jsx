...
import { aboutTechVistaVision } from "@/constants/aboutUsContent";

import aboutUsBanner from "../../../public/about-us-banner.webp";

import styles from "@/styles/pages/AboutUs.module.css";

const AboutUsVision = ({ sectionID }) => {
  return (
    <section id={sectionID} className={styles.aboutUsVisionSection}>
          ...
          <div className={styles.bannerOverlay}>
            ...
            >
              <Stack spacing={2} width={{ xs: "90%", lg: "50%" }}>
                <h3>{aboutTechVistaVision.heading}</h3>
                {aboutTechVistaVision.points.map((point, index) => (
                  <Stack
                    key={index}
                    direction={"row"}
                    spacing={2}
